...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Speak the decision and DecisionOS structures it into tasks, approvals and workflows - tracked, chased and permanently searchable." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "DecisionOS - The Operating Brain For Founder-Led Businesses" },
      { property: "og:description", content: "Speak the decision and DecisionOS structures it into tasks, approvals and workflows - tracked, chased and permanently searchable." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "DecisionOS - The Operating Brain For Founder-Led Businesses" },
